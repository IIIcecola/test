...
export CHECKPOINT_DIR="jingheya/lotus-depth-g-v2-0-disparity" # 模型路径
export OUTPUT_DIR="output/Depth_G_Infer" 
export TASK_NAME="depth"

# export CHECKPOINT_DIR="jingheya/lotus-normal-g-v1-0" # 模型路径
...
CUDA_VISIBLE_DEVICES=$CUDA python infer.py \
        --pretrained_model_name_or_path=$CHECKPOINT_DIR \ # 传入模型路径
