...
# 音频响度标准化标准
class AudioNormalization(Enum): # 音频响度标准化
    Disable = ""
    Radio = "loudnorm=i=-15.0:lra=2.0:tp=-1.0:" # # 广播标准
    TV = "loudnorm=i=-24.0:lra=2.0:tp=-1.0:" # 电视标准
    Movie = "loudnorm=i=-24.0:lra=7.0:tp=-2.0:" # 电影标准
...
class VideoCodec(Enum):
    H264 = "-c:v libx264 -crf 23 -preset slow -qcomp 0.5 -psy-rd 0.3:0 -aq-mode 2 -aq-strength 0.8" # 软件编码
